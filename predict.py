...
def prepare_input_sequences1(data_dir, sequence_length=3, target_size=(128, 128)):
...
def predict_and_save(model_path, data_dir, output_dir, sequence_length=3, sequence_step=1, target_size=(128, 128)):
    ...
    inputs_evi, inputs_ndwi, inputs_lst = prepare_input_sequences(data_dir, sequence_length, sequence_step, target_size)
